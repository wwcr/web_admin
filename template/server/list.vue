<template>
    <section>
        ...
        <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="server_title" label="服务标题" width="150" sortable>
            </el-table-column>
            <el-table-column prop="service_text" label="服务内容" width="300" sortable>
            </el-table-column>
            <el-table-column label="服务产品" width="120" sortable>
                <template scope="scope">
                    <el-button size="small" v-if="scope.row.product_id  == 1">车辆看护</el-button>
                    <el-button size="small" v-if="scope.row.product_id  == 2">寻车服务</el-button>
                </template>
            </el-table-column>
            <el-table-column prop="service_addtime" label="添加时间" width="180" sortable>
            </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //获取用户列表
            getUsers() {
                this.$http.post(units.host('server'),{
                    sw:'list',
                    page:this.page++,
                }).then( function (res) {
