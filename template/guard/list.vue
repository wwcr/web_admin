<template>
    <section>
        ...
        <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column label="用户" width="120" sortable>
            ...
            <el-table-column prop="card_model" label="车辆型号" width="120" sortable>
            </el-table-column>
            <el-table-column prop="card_color" label="颜色" width="100" sortable>
            </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //获取用户列表
            getUsers() {
                this.$http.post(units.host('guard'),{
                    switch:'list',
                    page:this.page++
                }).then( function (res) {
