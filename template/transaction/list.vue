    ...
    <section>
        ...
        <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column label="订单类型" width="120" sortable>
                <template scope="scope">
                    <el-button size="small" v-if="scope.row.order_type == 1">车辆看护</el-button>
                    <el-button size="small" v-if="scope.row.order_type == 2">寻车服务</el-button>
                </template>
            </el-table-column>
            <el-table-column prop="order_time" label="订单生成时间" width="150" sortable>
            </el-table-column>
            <el-table-column label="支付状态" width="120" sortable>
                <template scope="scope">
                    <el-button size="small" v-if="scope.row.pay_status == 1">待支付</el-button>
                    <el-button size="small" v-if="scope.row.pay_status == 2">支付成功</el-button>
                    <el-button size="small" v-if="scope.row.pay_status == 3">支付失败</el-button>
                    <el-button size="small" v-if="scope.row.pay_status == 4">退款</el-button>
                </template>
            </el-table-column>
