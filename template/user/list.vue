<template>
    <section>
        ...
        <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="user_nickname" label="昵称" width="150" sortable>
            </el-table-column>
            ...
            <el-table-column prop="user_regtime" label="注册时间" width="180" sortable>
            </el-table-column>
            <el-table-column label="是否认证" width="120" sortable>
                <template scope="scope">
                    <a :href="'#/user/terprise?uid='+scope.row.user_id">
                        <el-button size="small" v-if="scope.row.user_anthen == 0">未认证</el-button>
                        <el-button size="small" type="success" v-if="scope.row.user_anthen == 1">个人认证</el-button>
                        <el-button size="small" type="success" v-if="scope.row.user_anthen == 2">企业认证</el-button>
                    </a>
                </template>
            </el-table-column>
            <el-table-column label="用户状态" width="120" sortable>
                <template scope="scope">
                    <el-button size="small" icon="search" type="info" v-if="scope.row.user_status == 1">正常用户</el-button>
                    <el-button size="small" icon="delete" type="danger" v-if="scope.row.user_status == 0">被禁止</el-button>
                </template>
            </el-table-column>
        ...
        <el-col :span="24" class="toolbar">
            <a target="_blank" href="#/user/list"><el-button type="info" v-if="$route.query.uid">返回用户列表</el-button></a>
            <el-pagination
