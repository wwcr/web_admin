...
export default {
    ...
    host: function (name = '', model = 'Admin') {
        return 'http://h5.wwcrpt.com/index.php/index/'+model+'/' + name;
    },
    doname:function (name) {
        return 'http://h5.wwcrpt.com/'+name;
    },
    getHost:function () {
        return 'http://h5.wwcrpt.com';
    },
    domin:function (name = '') {
        return this.getHost()+'/index.php/api/'+ name;
    },
    damin:function (name) {
        return this.getHost()+'/index.php/admin/'+ name;
    },
    maketimegs:function (nS) {
    ...
    params:function (json,type) {
        ...
        let token = cookie.get('a_token');
        if(type)
        {
            return Object.assign({uid:uid,token:token},json)
        }
        return Object.assign({uid:uid,token:token},json)
    },
    api: function (name) {
        return 'http://h5.wwcrpt.com/api.php/' + name;
    },
    http: function () {
    },
    ...
    upload: function (formData, url = 'http://h5.wwcrpt.com') {
        $.ajax({
            url: url,
            type: 'POST',
            data: formData[0],
